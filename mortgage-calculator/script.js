...
function calculateMortgage() {
    ...
    // Calculate semi-annual compounding (Canadian standard)
    ...
    const firstPaymentInterest = mortgageAmount * effectiveMonthlyRate;
    ...
    // Calculate term summary values using amortization schedule
    let termPrincipal = 0;
    let termInterest = 0;
    let remainingBalance = mortgageAmount;
    
    for (let i = 0; i < numPaymentsInTerm; i++) {
        const monthlyInterest = remainingBalance * effectiveMonthlyRate;
